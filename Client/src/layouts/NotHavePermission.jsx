        ...
        >
            ...
            <div className="max-w-md w-full space-y-8 bg-white/90 backdrop-blur-md shadow-2xl rounded-3xl p-10 text-center relative">
                <div className="flex justify-center mb-6">
                    <div className="bg-green-100/80 p-4 rounded-full animate-pulse">
                        {/* Icon Lock */}
                        <svg
                ...
                <div className="space-y-4">
                    <button
                        onClick={() => navigate('/')}
                        className="group w-full flex items-center justify-center bg-green-500 text-white py-3 px-6 rounded-full
                ...
                <div className="mt-8 text-center">
                    <p className="text-sm font-sans text-gray-500">
                        ...
                        <a
                            ...
                            transition-all duration-300 hover:decoration-2 "
                        >
                            Liên hệ hỗ trợ
                        </a>
                    </p>
